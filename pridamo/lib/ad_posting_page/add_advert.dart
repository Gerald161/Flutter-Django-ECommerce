...
class _advertisementState extends State<advertisement> {
  ...
  Future<Map> post_pic_ad() async {
    var request = http.MultipartRequest('POST', Uri.parse('https://pridamo.com/handle_app_picture_upload?time_selected=${time_selected}'));
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
      appBar: AppBar(
        title: Text(
          'Post a picture product/service',
        ),
        centerTitle: true,
      ),
      body: FutureBuilder(
                        ...
                        onPressed: () async{
                          if(_formKey.currentState.validate()){
                            if(picture_taken == false){
                              showDialog(
                                  ...
                                  builder: (BuildContext context){
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                        "Please make sure an Image is uploaded",
                                        textAlign: TextAlign.center,
                                      ),
                                      actions: <Widget>[
                                        FlatButton(
                              ...
                              dynamic result = await post_pic_ad();
                            }
                          }
                        },
                        color: Colors.blue,
