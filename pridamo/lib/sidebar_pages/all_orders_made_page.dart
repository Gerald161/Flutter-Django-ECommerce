...
import 'package:pridamo/sidebar_pages/particular_store_orders.dart';
import 'package:shared_preferences/shared_preferences.dart';

class all_orders_made_page extends StatefulWidget {
  @override
  _all_orders_made_pageState createState() => _all_orders_made_pageState();
}

class _all_orders_made_pageState extends State<all_orders_made_page> {
  ...
  get_all_ordered_stores() async {
    ...
    var response = await http.get(
        'https://pridamo.com/profile/app_get_all_ordered_stores?num=$num&change=$change',
        headers: {
    ...
    return ListTile(
      onTap: ()async{
        var order_reponse_received = await Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => particular_store_orders(store_id: id, name: name),
          ),
        );
